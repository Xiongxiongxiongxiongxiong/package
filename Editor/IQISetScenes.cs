...
public class IQISetScenes : EditorWindow
{
    ...
    // {
    //     string gressPath = AssetDatabase.GetAssetPath(gress);
    //     // 查找所有以".asset"类型结尾的文件
    ...
    //                 {
    //                     // 如果物体名字和asset名字相同，添加VegetationLoader脚本
    ...
    //                     SerializedProperty assetProperty = serializedObject.FindProperty("assetFile");
